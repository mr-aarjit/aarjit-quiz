      ...
      <div className="relative z-10 text-center max-w-xl mx-auto w-full">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-secondary font-medium">Multiplayer Mode</span>
          </div>
        ...
        {showSetup ? (
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 mb-4 border border-border/50 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-medium text-teamA mb-1">Your Team (Host)</label>
                <Input
                  value={teamAName}
              ...
              <div>
                <label className="block text-xs font-medium text-teamB mb-1">Opponent Team</label>
                <Input
                  value={teamBName}
